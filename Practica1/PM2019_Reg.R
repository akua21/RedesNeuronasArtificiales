...
# trainSet <- read.csv("SotaventoTrain.txt",dec=".",sep=",",header = T)
# validSet <- read.csv( "SotaventoValid.txt",dec=".",sep=",",header = T)
# testSet  <- read.csv("SotaventoTest.txt",dec=".",sep=",",header = T)
